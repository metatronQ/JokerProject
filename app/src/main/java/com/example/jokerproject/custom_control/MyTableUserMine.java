...
public class MyTableUserMine extends RelativeLayout {
    ...
    private final String TAG = "MyTableUserMine";
            ...
            switch (msg.what){
                ...
                default:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        ...
                        getChildAt(msg.what).setBackground(ContextCompat.getDrawable(context,Transform.getTransform().toUri(JokerRecord.get(msg.what))));
                    }
                    break;
            }
        }
    ...
    public MyTableUserMine(Context context) {
        super(context);
    }

    public MyTableUserMine(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
